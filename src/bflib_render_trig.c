...
jump_pr_ll_md00_end:\n \
    ...
    if (lv.ll.var_8A)
    {
        ...
        // whether the addition (lv.ll.var_44 + lv.ll.var_78) would overflow
    ...
    else
    {
        if (lv.ll.var_8C)
        {
            ...
            if (lv.ll.var_8B) {
                ...
                // whether the subtraction (dH - lv.ll.var_38) would overflow
...
jump_pr_ll_md01_end:\n \
    ...
    lv.ll.var_80 = (lv.ll.var_38 << 16) / lv.ll.var_34;
    {
        ...
        if (eX != 0) {
            ...
            lv.ll.var_60 = (opt_b->S + wS - opt_a->S) / (eX + 1);
        }
    }
...
jump_pr_ll_md02_end:\n \
    ...
    lv.ll.var_80 = (lv.ll.var_38 << 16) / lv.ll.var_34;
    {
        ...
        if (eX != 0) {
            ...
            dS = opt_a->V - opt_c->V;
            wS = (lv.ll.var_80 * dS) >> 16;
            lv.ll.var_54 = (opt_b->V + wS - opt_a->V) / (eX + 1);
        }
    }
...
jump_pr_rl_md00_end:\n \
    ...
    if (lv.ll.var_8A)
    {
        ...
        lv.ll.var_44 = eH;
        lv.ll.var_6C = -lv.ll.var_78;
        if (lv.ll.var_6C - lv.ll.var_34 >= 0)
        {
            lv.ll.var_6C -= lv.ll.var_34;
            lv.ll.var_3C -= lv.ll.var_6C;
            pXb = lv.ll.var_30 * lv.ll.var_6C + lv.ll.var_40;
            pY += lv.ll.var_6C * lv.ll.var_2C + lv.ll.var_34 * lv.ll.var_2C;
            if (lv.ll.var_8C) {
              lv.ll.var_3C = vec_window_height;
              lv.ll.var_44 = vec_window_height;
            }
        ...
        {
            lv.ll.var_34 -= lv.ll.var_6C;
            pXa += lv.ll.var_28 * lv.ll.var_6C;
            pY += lv.ll.var_6C * lv.ll.var_2C;
            if (lv.ll.var_8C)
            {
                lv.ll.var_44 = vec_window_height;
                if (lv.ll.var_8B) {
                    ...
                    lv.ll.var_8B = vec_window_height <= lv.ll.var_34;
                    lv.ll.var_3C = vec_window_height - lv.ll.var_34;
                }
            }
            pXb = lv.ll.var_40;
        }
    ...
    else
    {
        if (lv.ll.var_8C)
        {
            ...
            if (lv.ll.var_8B) {
                ...
                eH_overflow = __OFSUBL__(dH, lv.ll.var_34);
                eH = dH - lv.ll.var_34;
                lv.ll.var_8B = ((eH < 0) ^ eH_overflow) | (eH == 0);
                lv.ll.var_3C = eH;
            }
...
jump_pr_rl_md01_end:\n \
    ...
    lv.ll.var_80 = (lv.ll.var_34 << 16) / lv.ll.var_38;
    {
        long dXa, wXb;
        long eX;
        TbBool eX_overflow;

        wXb = lv.ll.var_80 * (opt_b->X - opt_a->X) >> 16;
        dXa = opt_a->X - opt_c->X;
        ...
        if (eX != 0) {
            ...
            dS = opt_b->S - opt_a->S;
            wS = (lv.ll.var_80 * dS) >> 16;
            lv.ll.var_60 = (opt_a->S + wS - opt_c->S) / (eX + 1);
        }
    }
    lv.ll.var_64 = (opt_c->S - opt_a->S) / lv.ll.var_34;
    lv.ll.var_68 = (opt_b->S - opt_c->S) / lv.ll.var_3C;
    pXa = opt_a->X << 16;
    pY = opt_a->X << 16;
    pS = opt_a->S;
    if (lv.ll.var_8A)
    {
        ...
        if (lv.ll.var_6C - lv.ll.var_34 >= 0)
        {
            ...
            pXb = lv.ll.var_30 * lv.ll.var_6C + lv.ll.var_40;
            pY += lv.ll.var_6C * lv.ll.var_2C + lv.ll.var_34 * lv.ll.var_2C;
            pS += lv.ll.var_6C * lv.ll.var_68 + lv.ll.var_34 * lv.ll.var_64;
            if (lv.ll.var_8C) {
                lv.ll.var_3C = vec_window_height;
                lv.ll.var_44 = vec_window_height;
            }
...
jump_pr_rl_md02_end:\n \
    ...
    lv.ll.var_80 = (lv.ll.var_34 << 16) / lv.ll.var_38;
    {
        ...
        if (eX != 0) {
            ...
            dS = opt_b->U - opt_a->U;
            wS = (lv.ll.var_80 * dS) >> 16;
            lv.ll.var_48 = (opt_a->U + wS - opt_c->U) / (eX + 1);
            dS = opt_b->V - opt_a->V;
            wS = (lv.ll.var_80 * dS) >> 16;
            lv.ll.var_54 = (opt_a->V + wS - opt_c->V) / (eX + 1);
        }
    }
    lv.ll.var_4C = (opt_c->U - opt_a->U) / lv.ll.var_34;
    lv.ll.var_58 = (opt_c->V - opt_a->V) / lv.ll.var_34;
    lv.ll.var_50 = (opt_b->U - opt_c->U) / lv.ll.var_3C;
    lv.ll.var_5C = (opt_b->V - opt_c->V) / lv.ll.var_3C;
    pXa = opt_a->X << 16;
    pY = opt_a->X << 16;
    pU = opt_a->U;
    pV = opt_a->V;
    if (lv.ll.var_8A)
    {
        ...
        if (lv.ll.var_6C - lv.ll.var_34 >= 0)
        {
            ...
            pXb = lv.ll.var_30 * lv.ll.var_6C + lv.ll.var_40;
            pY += lv.ll.var_6C * lv.ll.var_2C + lv.ll.var_34 * lv.ll.var_2C;
            pU += lv.ll.var_6C * lv.ll.var_50 + lv.ll.var_34 * lv.ll.var_4C;
            pV += lv.ll.var_6C * lv.ll.var_5C + lv.ll.var_34 * lv.ll.var_58;
            if (lv.ll.var_8C) {
                lv.ll.var_3C = vec_window_height;
                lv.ll.var_44 = vec_window_height;
            }
...
jump_pr_fb_md01_end:\n \
...

    {
        long dX;
        dX = opt_b->X - opt_c->X;
        lv.ll.var_60 = (opt_b->S - opt_c->S) / dX;
...
jump_pr_fb_md02_end:\n \
...

    {
        long dX;
        dX = opt_b->X - opt_c->X;
        lv.ll.var_48 = (opt_b->U - opt_c->U) / dX;
        lv.ll.var_54 = (opt_b->V - opt_c->V) / dX;
        lv.ll.var_4C = (opt_c->U - opt_a->U) / lv.ll.var_44;
        lv.ll.var_58 = (opt_c->V - opt_a->V) / lv.ll.var_44;
    }
    pX = opt_a->X << 16;
    pY = opt_a->X << 16;
    pU = opt_a->U;
    ...
    if (lv.ll.var_8A)
    {
        ...
        pX += lv.ll.var_28 * (-lv.ll.var_78);
        pY += (-lv.ll.var_78) * lv.ll.var_2C;
        pU += (-lv.ll.var_78) * lv.ll.var_4C;
        pV += (-lv.ll.var_78) * lv.ll.var_58;
        if (lv.ll.var_8B) {
            lv.ll.var_44 = vec_window_height;
            lv.ll.var_34 = vec_window_height;
        }
...
jump_pr_ft_md02_end:\n \
    ...
    struct PolyPoint *pp;
    {
        long dX;
        dX = opt_b->X - opt_a->X;
        lv.ll.var_48 = (opt_b->U - opt_a->U) / dX;
        lv.ll.var_54 = (opt_b->V - opt_a->V) / dX;
        lv.ll.var_4C = (opt_c->U - opt_a->U) / lv.ll.var_44;
        lv.ll.var_58 = (opt_c->V - opt_a->V) / lv.ll.var_44;
    }
    pX = opt_a->X << 16;
