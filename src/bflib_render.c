...
/* Temporary hack while the tests are getting moved to bflibrary */
#include "../bflibrary/tests/mock_mouse.c"
#include "../bflibrary/tests/mock_palette.c"
#include "../bflibrary/tests/mock_screen.c"
#include "../bflibrary/tests/mock_windows.c"
