...
#endif
    dword_1AA270 = 1;
    colour_lookup[0] = LbPaletteFindColour(display_palette, 0, 0, 0);
    colour_lookup[1] = LbPaletteFindColour(display_palette, 63, 63, 63);
    colour_lookup[2] = LbPaletteFindColour(display_palette, 63, 0, 0);
    colour_lookup[3] = LbPaletteFindColour(display_palette, 0, 63, 0);
    colour_lookup[4] = LbPaletteFindColour(display_palette, 0, 0, 63);
    colour_lookup[5] = LbPaletteFindColour(display_palette, 63, 63, 0);
    colour_lookup[6] = LbPaletteFindColour(display_palette, 0, 63, 63);
    colour_lookup[7] = LbPaletteFindColour(display_palette, 63, 0, 63);
    colour_lookup[8] = LbPaletteFindColour(display_palette, 50, 50, 50);
    colour_lookup[9] = LbPaletteFindColour(display_palette, 30, 30, 30);
    colour_lookup[10] = LbPaletteFindColour(display_palette, 10, 10, 10);
    dword_1AA270 = 0;
