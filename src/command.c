...
enum CommandDefFlags {
    CmDF_None = 0x0000,
    CmDF_ReqCoord = 0x0001,
    CmDF_ReqOtherThing = 0x0002,
    CmDF_ReqArgs2 = 0x0004,
    CmDF_ReqSubType = 0x0008,
    CmDF_ReqMyThing = 0x0010,
    CmDF_ReqParent = 0x0020,
};
...
struct CommandDef command_defs[] = {
    ...
    {"TNG_CMD_GO_TO_POINT",			NULL,				CmDF_None },
    {"TNG_CMD_GO_TO_PERSON",		NULL,				CmDF_None },
    {"TNG_CMD_KILL_PERSON",			NULL,				CmDF_None },
    {"TNG_CMD_KILL_MEM_GROUP",		NULL,				CmDF_None },
    {"TNG_CMD_KILL_ALL_GROUP",		NULL,				CmDF_None },
    {"TNG_CMD_PERSUADE_PERSON",		NULL,				CmDF_None },
    {"TNG_CMD_PERSUADE_MEM_GROUP",	NULL,				CmDF_None },
    {"TNG_CMD_PERSUADE_ALL_GROUP",	NULL,				CmDF_None },
    {"TNG_CMD_BLOCK_PERSON",		NULL,				CmDF_None },
    {"TNG_CMD_SCARE_PERSON",		NULL,				CmDF_None },
    {"TNG_CMD_FOLLOW_PERSON",		NULL,				CmDF_None },
    {"TNG_CMD_SUPPORT_PERSON",		NULL,				CmDF_None },
    {"TNG_CMD_PROTECT_PERSON",		NULL,				CmDF_None },
    {"TNG_CMD_HIDE",				NULL,				CmDF_None },
    {"TNG_CMD_GET_ITEM",			NULL,				CmDF_None },
    {"TNG_CMD_USE_WEAPON",			NULL,				CmDF_None },
    {"TNG_CMD_DROP_SPEC_ITEM",		NULL,				CmDF_None },
    {"TNG_CMD_AVOID_PERSON",		NULL,				CmDF_None },
    {"TNG_CMD_WAND_AVOID_GROUP",	NULL,				CmDF_None },
    {"TNG_CMD_DESTROY_BUILDING",	NULL,				CmDF_None },
    {"TNG_CMD_UNKN16",				NULL,				CmDF_None },
    {"TNG_CMD_USE_VEHICLE",			NULL,				CmDF_None },
    {"TNG_CMD_EXIT_VEHICLE",		NULL,				CmDF_None },
    {"TNG_CMD_CATCH_TRAIN",			NULL,				CmDF_None },
    {"TNG_CMD_OPEN_DOME",			NULL,				CmDF_None },
    {"TNG_CMD_CLOSE_DOME",			NULL,				CmDF_None },
    {"TNG_CMD_DROP_WEAPON",			NULL,				CmDF_None },
    {"TNG_CMD_CATCH_FERRY",			NULL,				CmDF_None },
    {"TNG_CMD_EXIT_FERRY",			NULL,				CmDF_None },
    {"TNG_CMD_PING_EXIST",			NULL,				CmDF_None },
    {"TNG_CMD_GOTOPOINT_FACE",		NULL,				CmDF_None },
    {"TNG_CMD_SELF_DESTRUCT",		NULL,				CmDF_None },
    {"TNG_CMD_PROTECT_MEM_G",		NULL,				CmDF_None },
    {"TNG_CMD_RUN_TO_POINT",		NULL,				CmDF_None },
    {"TNG_CMD_KILL_EVERYONE",		NULL,				CmDF_None },
    ...
    {"TNG_CMD_WAIT_MEM_G_DEAD",		NULL,				CmDF_None },
    {"TNG_CMD_WAIT_ALL_G_DEAD",		NULL,				CmDF_None },
    {"TNG_CMD_WAIT_P_V_I_NEAR",		NULL,				CmDF_None },
    {"TNG_CMD_WAIT_MEM_G_NEAR",		NULL,				CmDF_None },
    {"TNG_CMD_WAIT_ALL_G_NEAR",		NULL,				CmDF_None },
    {"TNG_CMD_WAIT_P_V_I_ARRIVES",	NULL,				CmDF_None },
    {"TNG_CMD_WAIT_MEM_G_ARRIVE",	NULL,				CmDF_None },
    {"TNG_CMD_WAIT_ALL_G_ARRIVE",	NULL,				CmDF_None },
    {"TNG_CMD_WAIT_P_PERSUADED",	NULL,				CmDF_None },
    {"TNG_CMD_WAIT_MEM_G_PERSUADED",NULL,				CmDF_None },
    {"TNG_CMD_WAIT_ALL_G_PERSUADED",NULL,				CmDF_None },
    ...
    {"TNG_CMD_WAIT_OBJECT_DESTROYED",NULL,				CmDF_None },
    ...
    {"TNG_CMD_WAND_MEM_G_DEAD",		NULL,				CmDF_None },
    {"TNG_CMD_WAND_ALL_G_DEAD",		NULL,				CmDF_None },
    {"TNG_CMD_WAND_P_V_I_NEAR",		NULL,				CmDF_None },
    {"TNG_CMD_WAND_MEM_G_NEAR",		NULL,				CmDF_None },
    {"TNG_CMD_WAND_ALL_G_NEAR",		NULL,				CmDF_None },
    {"TNG_CMD_WAND_P_V_I_ARRIVES",	NULL,				CmDF_None },
    {"TNG_CMD_WAND_MEM_G_ARRIVE",	NULL,				CmDF_None },
    {"TNG_CMD_WAND_ALL_G_ARRIVE",	NULL,				CmDF_None },
    {"TNG_CMD_WAND_P_PERSUADED",	NULL,				CmDF_None },
    {"TNG_CMD_WAND_MEM_G_PERSUADED",NULL,				CmDF_None },
    {"TNG_CMD_WAND_ALL_G_PERSUADED",NULL,				CmDF_None },
    ...
    {"TNG_CMD_WAND_OBJECT_DESTROYED",NULL,				CmDF_None },
    ...
    {"TNG_CMD_UNKN68",				NULL,				CmDF_None },
    {"TNG_CMD_UNKN69",				NULL,				CmDF_None },
    {"TNG_CMD_UNKN6A",				NULL,				CmDF_None },
    {"TNG_CMD_UNKN6B",				NULL,				CmDF_None },
    {"TNG_CMD_UNKN6C",				NULL,				CmDF_None },
    {"TNG_CMD_UNKN6D",				NULL,				CmDF_None },
    {"TNG_CMD_LOOP_COM",			NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_P_V_DEAD",		NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_MEM_G_DEAD",	NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_ALL_G_DEAD",	NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_P_V_I_NEAR",	NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_MEM_G_NEAR",	NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_ALL_G_NEAR",	NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_P_V_I_ARRIVES",	NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_MEM_G_ARRIVE",	NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_ALL_G_ARRIVE",	NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_P_PERSUADED",	NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_MEM_G_PERSUADED",NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_ALL_G_PERSUADED",NULL,				CmDF_None },
    ...
    {"TNG_CMD_UNTIL_OBJECT_DESTROYED",NULL,				CmDF_None },
    ...
    {"TNG_CMD_LOCK_BUILD",			NULL,				CmDF_None },
    {"TNG_CMD_UNLOCK_BUILD",		NULL,				CmDF_None },
    {"TNG_CMD_SELECT_WEAPON",		NULL,				CmDF_None },
    {"TNG_CMD_HARD_AS_AGENT",		NULL,				CmDF_None },
    {"TNG_CMD_UNTIL_G_NOT_SEEN",	NULL,				CmDF_None },
    {"TNG_CMD_START_DANGER_MUSIC",	NULL,				CmDF_None },
    {"TNG_CMD_PING_P_V",			NULL,				CmDF_None },
    {"TNG_CMD_CAMERA_TRACK",		NULL,				CmDF_None },
    {"TNG_CMD_UNTRUCE_GROUP",		NULL,				CmDF_None },
    {"TNG_CMD_PLAY_SAMPLE",			NULL,				CmDF_None },
    {"TNG_CMD_IGNORE_ENEMIES",		NULL,				CmDF_None },
    {"TNG_CMD_UNKN90",				NULL,				CmDF_None },
    {"TNG_CMD_UNKN91",				NULL,				CmDF_None },
    {NULL,							NULL,				CmDF_None },
};
