...
void show_net_benefits_sub1(short x0, short y0, TbPixel colour)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        p_sprite = &fe_icons0_sprites[spridx];
...
void show_net_benefits_sub3(struct ScreenBox *box)
{
    ...
    draw_sprite_purple_list(box1.X, box1.Y, &fe_icons0_sprites[108]);
}
...
void show_net_benefits_sub4(struct ScreenBox *box)
{
    ...
    draw_sprite_purple_list(box2.X - 7, box2.Y, &fe_icons0_sprites[109]);
}
