...
class MouseStateHandler {
 public:
    ...
    bool SetMousePosition(i32 x, i32 y);
    bool SetPosition(i32 x, i32 y);
    const struct TbSprite *GetPointer(void);
    bool SetMousePointerAndOffset(const struct TbSprite *mouseSprite, i32 x, i32 y);
    bool SetMousePointer(const struct TbSprite *mouseSprite);
    bool SetPointerOffset(i32 x, i32 y);
    struct TbPoint *GetPointerOffset(void);
    bool SetMouseWindow(i32 x, i32 y, i32 width, i32 height);
