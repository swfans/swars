/*
 * This function gets passed lbDisplay__GraphicsScreenWidth/2, lbDisplay__GraphicsScreenHeight/2, perhaps to put
...
e9568_set_pointer_position (uint32_t *x, uint32_t *y)
{
  ...
  /*
   * This function refers to PhysicalScreen, it may have something to do with
   * drawing the pointer.
   */
